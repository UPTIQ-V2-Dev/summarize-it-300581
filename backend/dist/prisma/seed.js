...
async function main() {
    ...
    void (await prisma.summary.upsert({
        ...
        create: {
            ...
            originalText: 'Artificial Intelligence (AI) has transformed numerous industries by enabling machines to perform tasks that traditionally required human intelligence. From natural language processing to computer vision, AI technologies are revolutionizing how we interact with technology and process information. Machine learning algorithms can now analyze vast amounts of data to identify patterns, make predictions, and automate complex decision-making processes.',
            summaryText: 'AI has revolutionized industries through machine learning and automation, enabling pattern recognition and complex decision-making.',
    ...
    void (await prisma.summary.upsert({
        ...
        create: {
            ...
            summaryText: 'Climate change causes rising temperatures, extreme weather, and environmental disruption with economic consequences.',
